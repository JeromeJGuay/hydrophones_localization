classdef figures
    ...
    methods (Static= true, Access= private)
        ...
        function pyramid_3d_plot(receivers, color, labels)
            plot3(receivers(1,:),receivers(2,:),receivers(3,:), strcat(color,'.'),'MarkerSize',10)
            trisurf(boundary(receivers',1),receivers(1,:)',receivers(2,:)',receivers(3,:)','FaceColor',color,'FaceAlpha',0.1)
